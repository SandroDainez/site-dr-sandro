    ...
    <div className="min-h-screen bg-[#0f1420] text-white">
      ...
      <header data-typo="header" className="sticky top-0 z-50 border-b border-white/10 bg-[#0f1420]/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-3 px-6 py-4 lg:flex-row lg:justify-between lg:gap-0">
          ...
          <Link href="/artigos" className="flex items-center gap-1 text-sm text-white/50 transition hover:text-white lg:hidden">← Artigos</Link>
        </div>
      </header>

      <main className="mx-auto w-full max-w-3xl px-6 py-14">
        <Link href="/artigos" className="mb-6 inline-flex items-center gap-1.5 text-sm text-white/50 transition hover:text-white">← Todos os artigos</Link>
