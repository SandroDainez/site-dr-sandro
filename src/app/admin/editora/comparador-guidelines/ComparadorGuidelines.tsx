...
import { Loader2, GitCompare, Save, AlertTriangle, FileText, X, ShieldCheck, Cpu, CheckCircle2, Library, BookOpen, Plus } from "lucide-react";
            ...
            <div className={card}>
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[11px] text-white/40">{validacao.validadas}/{validacao.totalClinicas} posições com citação validada · {validacao.semFonte} sem fonte · {validacao.invalidas} inválidas</p>
                </div>
              </div>
