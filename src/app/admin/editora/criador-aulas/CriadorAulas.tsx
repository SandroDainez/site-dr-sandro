      ...
      {doc && (
        <>
          ...
          <div className={card}>
            ...
            <p className="mt-2 text-[11px] text-white/35">Publicar trava a versão mais recente (imutável) e a torna pública em /aulas. Editar depois cria um novo rascunho; a versão pública só muda quando você republicar.</p>
          </div>
        </>
      )}
