...
export default async function CriadorAulasPage() {
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-white">Criador de Aulas {modo === "real"
        ...
        <p className="mt-1 text-sm text-white/50">
          Monta uma aula em <strong className="text-white/70">seções/slides</strong> a partir das <strong className="text-white/70">referências</strong>,
          ajustada ao <strong className="text-white/70">público-alvo</strong>, com validação de citações e confiança calculada pelo código. {modo === "real"
      ...
      <AdminHelp>
        ...
        <strong className="text-white/85"> público-alvo</strong>. 4) Clique em <strong className="text-white/85">Gerar aula</strong>.
        5) Revise/edite, rode a <strong className="text-white/85">revisão</strong> e <strong className="text-white/85">salve</strong>.
        6) Publique quando quiser — vai para /aulas.
      </AdminHelp>

      <CriadorAulas docsIniciais={docs} modo={modo} />
    </div>
  );
}
